...
<xsl:choose>
<xsl:when test="$container = 'circular_buffer'">
<xsl:apply-templates select="document(concat($xmldir, '/base_8hpp.xml'))/doxygen/compounddef/sectiondef[@kind='func']/memberdef" mode="synopsis"/>
</xsl:when>
<xsl:when test="$container = 'circular_buffer_space_optimized'">
<xsl:apply-templates select="document(concat($xmldir, '/adaptor_8hpp.xml'))/doxygen/compounddef/sectiondef[@kind='func']/memberdef" mode="synopsis"/>
</xsl:when>
</xsl:choose>
} // namespace boost
</pre>
